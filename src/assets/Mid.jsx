...
// https://th.bing.com/th/id/OIG.KMLkKBgPLvSwUZ9KPaGG?pid=ImgGn
...
function Mid() {
  return (
    <div>
    <div >
    <Parallax className='w-auto h-[600px]' bgImage="./bg.jpg"  strength={600}>
    <div className='text-center pt-48  text-3xl text-white p-12'>
    <h1 className='pr-20 pl-20'>Life is about moments, don’t wait for them, create them.</h1>
    <p className='font-light pt-8 '><em>We love to create beautiful experiences<br/> to impress our clients and 
    ...
    <div className='flex flex-col flex-wrap md:gap-1 gap-20 '>
     <div className='md:flex md:flex-row flex flex-col justify-between gap-6'>
        ...
        <p className='md:p-24 md:text-2xl text-lg font-light text-gray-500 p-8'><span className='text-black font-medium text-3xl font-[Poppins]'>At Iceland Moments,</span> we embody the skill of treating our valued customers to the true spirit of Iceland, as if viewed through the eyes of a local expert. Our unwavering dedication revolves around creating unmatched, lasting memories for our guests, seamlessly weaving them into the fabric of local life, exceptional food, untouched landscapes, and the captivating wildlife that graces this land.</p>
     </div>
     <div className='md:flex md:flex-row flex flex-col justify-between gap-6'>
        <p className='md:p-24 md:text-2xl text-lg font-light text-gray-500 p-8'>
        <span className='text-black font-medium text-3xl font-[Poppins]'> We believe</span> that sometimes less is more. We like to mix a busy schedule with some time for slow travel, that's where the magic tends to happen.
...
<img className='md:h-1/2 md:w-1/2 h-[400px] bg-cover' src="https://th.bing.com/th/id/OIG.816DnFjXoYjqh5KasocG?pid=ImgGn"></img>
    ...
    <div className='flex flex-row flex-wrap justify-center gap-12 m-8'>
        {images.map((item,id)=>{
            return (
                <div key={id}>
